...
_EXTRACT_SCHEMA = (
    ...
    '  "trip_info": {\n'
    '    "ciudad": "<ciudad DESTINO del viaje — SOLO el nombre de la ciudad, sin país, sin estado, sin coma. '
    'Ej: \'Guadalajara\' NO \'Guadalajara, México\'; \'Bogotá\' NO \'Bogotá, Colombia\'; '
    '\'Ciudad de México\' NO \'CDMX, México\'. Si ves un código IATA, tradúcelo: GDL=Guadalajara, '
    'BOG=Bogotá, MEX=Ciudad de México, CUN=Cancún, MTY=Monterrey, MDE=Medellín, CLO=Cali. O null si no aparece>",\n'
